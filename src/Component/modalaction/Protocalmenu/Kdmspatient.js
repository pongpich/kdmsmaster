...
import Kd from "../../../assets/img/checklist.svg";
...
function Kdmspatient() {
  ...
  const SavePost = async () => {
    ...
    let newArray = dataex.filter((dataex) =>
      railCards.some((railCards) => railCards.value === dataex.AssCod)
    );
    ...
    for (let i = 0; i < newArray.length; i++) {
      ...
      const reques = {
        params: {
          ...
          settyp: element.HpmCat.trim(), //of data <-- PTT,PTV,SGT,ASSMENT,MED มีอะไรบ้างส่งไปตามนั้น
          setprd: "1", //week
          setseq: "", //row of record, //PTT record ที่ ?
          dtlcod: element.AssCod.trim(), // code ของ แต่ละหัวข้อ
    ...
    <div>
      <div className="grid grid-cols-12">
        <div className="col-span-1 ">
          <img src={Kd} alt="" width="24" className="ml-1" />
        </div>
        <div className="col-span-11 font-medium">
          <div className="text-md font-semibold">
            Kdms Patient Self Record Program (KPRP)
            <span
      ...
      <div className="grid grid-cols-12">
        <div className="col-span-1 ">
          ...
          <div className="flex">
            ...
            <div className=" text-xs">Kw-2</div>
          </div>
        </div>
        <div
                ...
                <div className=" bg-neutral-100 h-80 ">
                  <div className=" text-center py-5 mx-5 ">
                    ...
                    <div className="passanger-dropdown-item--left w-100">
                      <button
                        type="button"
                        className="btn custom-link mb-2 my-2"
                          ...
                          ({ value, fieldName, count, id }, index) => (
                            ...
                            >
                              <select
                                defaultValue={value}
                                name={fieldName}
                                className="form-control passanger-dropdown-item--select w-11/12 mr-1 my-1"
                                data-index={id}
